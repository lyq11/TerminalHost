...
Copy-Item -LiteralPath (Join-Path $root "release-assets\Start-TerminalHost.cmd") -Destination $stageRoot
Copy-Item -LiteralPath (Join-Path $root "release-assets\TerminalHost-MCP-stdio.cmd") -Destination $stageRoot
Copy-Item -LiteralPath (Join-Path $root "release-assets\Start-MCP-HTTP.cmd") -Destination $stageRoot
